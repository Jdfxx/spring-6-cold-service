...
import pl.filiphagno.spring6coldservice.services.DrinkRequestProcessor;
...
public class DrinkRequestListener {
    ...
    @KafkaListener(groupId = "IceColdListener", topics = KafkaConfig.DRINK_REQUEST_COLD_TOPIC)
